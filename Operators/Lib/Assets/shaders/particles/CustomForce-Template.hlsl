...
//----------------------------------------------
    ...
    Particles[idx].Velocity = lerp(Particles[idx].Velocity, v, Amount);
    Particles[idx].Color = lerp(Particles[idx].Color, p.Color, Amount);
    Particles[idx].Position = lerp(Particles[idx].Position, p.Position, Amount);
}
